...
(function ($) {
    ...
    //setBG("images/test.png", "u6GpiwJDtGYgVNxw988pxLnhxkUTXZNahtCVPrNYhilwwOlAKplMGxSdrhQAhDof", function () {
    //    doscale();
    //});
    ...
    $("#page-3").find(".set-os .btn.next").on("touchend", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //var opt = {
                //    title: '宝宝你究竟闹哪样!？', // 分享标题
                //    desc: "宝宝你想闹哪样？?哄娃秘诀在这里！", // 分享描述
                //    imgUrl: "http://qichugiving.weixinzjit.com/images/share.jpg",// 分享图标
                //    success: function () {
                //        alert('成功分享到朋友圈');
                //    },
                //    cancel: function () {
